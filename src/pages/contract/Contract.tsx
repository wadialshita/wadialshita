...
export const Contract = ({ form }: any) => {
    ...
    return (
        ...
        >
            <table className="table  text-black border-black table-auto border-2">
                <tbody>
                    <tr style={{ height: '34px',border:'    1px solid black' }}>
                    ...
                    <tr className="fw-bold" style={{ height: '15px', fontSize: '10px',border:'    1px solid black' }}>
                    ...
                    <tr style={{ height: '15px', fontSize: '10px',border:'    1px solid black' }} className="h-fit">
                    ...
                    <tr style={{ height: '15px', fontSize: '10px',border:'    1px solid black'}}>
                        <td className="s4" colSpan={9}>
                    ...
                    {/* <tr style={{ fontSize: '10px', height: '15px', textAlign: 'center' }}>
                        <td colSpan={9}></td>
                    </tr> */}
                    <tr style={{ height: '15px', fontSize: '10px', textAlign: 'center' ,border:'    1px solid black'}}>
                        <td colSpan={9} style={{}}>
                            اسم صاحب الحساب :
                    ...
                    <tr style={{ fontSize: '10px', height: '15px', textAlign: 'center',border:'    1px solid black' }}>
                    ...
                    <tr style={{ height: '15px', fontSize: '10px',border:'    1px solid black' }}>
                        ...
                        <td className="s7" style={{border:'    1px solid black'}}  colSpan={2} rowSpan={2}></td>
                    </tr>
                    <tr style={{ height: '15px', fontSize: '10px',border:'    1px solid black' }}>
                        <td className="s9" colSpan={7}>
