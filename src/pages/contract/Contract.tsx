        ...
        >
            <table className="  text-black  table-auto ">
                <tbody>
                    ...
                    <tr className="fw-bold" style={{ height: '25px', fontSize: '10px',border:'    0.5px solid black' }}>
                    ...
                    <tr style={{ height: '25px', fontSize: '10px',border:'    0.5px solid black' }} >
                    ...
                    {/* <tr style={{ fontSize: '10px', height: '25px', textAlign: 'center' }}>
                        <td colSpan={9}></td>
                    </tr> */}
                    <tr style={{ height: '25px', fontSize: '10px', textAlign: 'center' ,border:'    0.5px solid black'}}>
                        <td colSpan={9} style={{}}>
                            اسم صاحب الحساب :
                    ...
                    <tr style={{ fontSize: '10px', height: '25px', textAlign: 'center',border:'    0.5px solid black' }}>
                    ...
                    <tr style={{ height: '25px',border:'0.5px solid black' }}>
