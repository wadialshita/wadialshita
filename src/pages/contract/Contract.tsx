        ...
        >
            <table className="table table-bordered text-black border-black">
                <tbody>
                    ...
                    <tr className="fw-bold" style={{ height: '15px', fontSize: '10px' }}>
                    ...
                    <tr style={{ height: '15px', fontSize: '10px' }} className="h-fit">
                    ...
                    <tr style={{ height: '15px', fontSize: '10px' }}>
                        <td className="s4" colSpan={9}>
                    ...
                    <tr style={{ height: '15px', fontSize: '10px', textAlign: 'center' }}>
                        <td colSpan={9} style={{}}>
                            اسم صاحب الحساب :
